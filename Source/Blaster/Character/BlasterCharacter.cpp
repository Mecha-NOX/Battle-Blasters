...
void ABlasterCharacter::PossessedBy(AController* NewController)
{
	...
	BlasterPlayerController = BlasterPlayerController == nullptr ? Cast<ABlasterPlayerController>(NewController) : BlasterPlayerController;
...
void ABlasterCharacter::ServerSetPlayerName_Implementation(const FString& PlayerName)
{
	if (BlasterPlayerState)
	{
		BlasterPlayerState->SetPlayerName(PlayerName);
	}
}
